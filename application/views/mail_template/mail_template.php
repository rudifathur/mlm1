  ...
  <div id="main" style="width:90%; height:725px; border:1px solid #CCC;">
    <div id="header" style="width:100%; height:70px; border:0px solid #000;">
      <div id="logo" style="width:49%; float:left; border:0px solid #000;">
        <img style="padding: 25px; width: 170px;" src="http://ovejobs.com/public/images/logo.jpg" />
      </div>
      <div align="right" id="contact" style="width:49%; float:left; border:0px solid #000;">
        <p style="margin-top: 34px;">Email : <a style="color:#066;">serdaducoding@gmail.com</a></p>
        <p>Contact No. : 085270894061</p>
      </div>
    </div>
    ...
    <div>
      ...
      <p style="margin-left: 35px;"> For any queries or assistance, mail to <a href="#">serdaducoding@gmail.com</a>
        or Call Us at: 085270894061 </p>
      <br />
    ...
    <div id="titllebar" style="width:100%; height:50px;background-color: aliceblue;">
      <div style="width:50%; float:left; color: #272020;font-size: 23px; margin-top: 12px; padding-left: 11px;">MLM .</div>
