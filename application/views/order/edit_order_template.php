               ...
               <form role="form" id="ProductForm" action="<?= base_url('edit_product'); ?>" method="post" enctype="multipart/form-data">
                 <div class="box-body">
                   ...
                   <div class="col-md-6">
                     ...
                     <div class="form-group">
                       <label for="exampleInputPassword1">Katagori Produk</label>
                     ...
                     <div class="form-group">
                       ...
                       <input type="number" class="form-control" id="SalePrice" value="<?= $product['SalePrice']; ?>" placeholder="Harga Jual">
                       <p class="help-block"></p>
                     </div>
                   ...
                   <div class="col-md-12">
                     <div class="form-group">
                       ...
                       <textarea class="form-control" id="description" placeholder="deskripsi Produk"><?= $product['description']; ?></textarea>
                       <p class="help-block"></p>
                     </div>
                   </div>
