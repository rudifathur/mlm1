                 ...
                 <div class="box-body">
                   ...
                   <div class="col-md-6">
                     <div class="form-group">
                       <label for="exampleInputPassword1">Lihat pesanan No.</label>
                   ...
                   <div class="col-md-6">
                     <div class="form-group">
                       ...
                       <button style="margin-top: 25px;" type="button" class="btn btn-primary GetInvoiceBtn">Dapatkan Bon/Faktur</button>
                   ...
                   <div class="col-md-12" style="display:none;" id="progressBar">
                     <div class="progress">
                       <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:100%">
                         Silahkan Tunggu Generating Bon/Faktur.....
                       </div>
                     </div>
                   </div>
