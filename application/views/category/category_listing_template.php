 				...
 				<div class="row">
 					<div class="col-xs-12">
 						<div class="box">
 							...
 							<button style="margin-left: 10px;" type="button" class="btn btn-info" onClick="add();">Tambah katagori</button>
 						...
 						<div class="modal-body" style="padding:0px;">
 							...
 							<div class="box box-primary">
 								<div class="box-header with-border">
 									<h3 class="box-title">Lihat Katagori Details</h3>
 								</div>
 								<div class="box-body">
 									...
 									<div class="col-md-12">
 										<div class="form-group">
 											<label for="exampleInputPassword1">Deskripsi Katagori</label>
